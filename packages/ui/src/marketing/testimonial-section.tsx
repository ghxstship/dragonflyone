    ...
    <div className="flex gap-1">
      {[1, 2, 3, 4, 5].map((star) => (
        <svg
          ...
          className={clsx(
            "size-5",
            star <= rating ? "text-accent fill-accent" : "text-grey-600"
          )}
          viewBox="0 0 20 20"
        >
  ...
  return (
    <Card className="p-6 md:p-8 border-2 border-grey-800 rounded-card h-full">
      <Stack gap={6} className="h-full">
        ...
        {/* Quote */}
        <Body className="text-grey-200 italic flex-1 text-lg leading-relaxed">
                  ...
                  {testimonials.map((_, idx) => (
                    <button
                      ...
                      className={clsx(
                        ...
                        idx === currentIndex ? "bg-primary" : "bg-grey-600"
                      )}
            ...
            <div className="max-w-4xl mx-auto">
              <Card className="p-8 md:p-12 border-2 border-primary/30 rounded-card bg-gradient-to-br from-primary/10 to-transparent">
                <Stack gap={8} className="text-center items-center">
                  ...
                  <Body className="text-grey-200 italic text-xl md:text-2xl leading-relaxed max-w-3xl">
