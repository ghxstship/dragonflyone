...
import { dashboardBuilderVariants, widgetVariants, widgetPaletteVariants } from "./DashboardBuilder.variants.js";
import type { 
  ...
  WidgetConfig,
  WidgetPaletteItem
} from "./DashboardBuilder.types.js";
...
/**
 * DashboardBuilder component - Bold Contemporary Pop Art Adventure
 * 
 * Features:
    ...
    <div className={clsx(dashboardBuilderVariants({ editMode }), className)}>
      ...
      {editMode && (
        ...
        >
          ...
          <div className="flex items-center gap-2">
            {onSetDefault && (
              <Tooltip content={dashboard.isDefault ? "Default dashboard" : "Set as default"}>
                <button
                  type="button"
            ...
            {onShare && (
              <Tooltip content={dashboard.isPublic ? "Shared" : "Share dashboard"}>
                <button
                  type="button"
