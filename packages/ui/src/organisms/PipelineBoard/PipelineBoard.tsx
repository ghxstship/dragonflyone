...
import { pipelineBoardVariants } from "./PipelineBoard.variants.js";
import type { PipelineBoardProps, PipelineDeal } from "./PipelineBoard.types.js";
...
export function PipelineBoard({
  ...
  return (
    ...
    >
      <div className={pipelineBoardVariants({ loading: isLoading })}>
        {stages.map((stage) => {
