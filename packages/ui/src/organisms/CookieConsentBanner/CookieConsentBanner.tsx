...
import { cookieConsentBannerVariants } from "./CookieConsentBanner.variants.js";
import type { CookieConsentBannerProps, CookiePreferences } from "./CookieConsentBanner.types.js";
import { Button } from "../../atoms/Button/index.js";
import { Body, Label } from "../../atoms/Typography/index.js";
    ...
    return (
      <>
        ...
        <div
          ...
          className={clsx(
            cookieConsentBannerVariants({ position }),
            className
          )}
          {...props}
        >
          <div className="p-6 max-w-container-4xl mx-auto">
            <Stack gap={4}>
              ...
              <div className="flex items-start justify-between gap-4">
                ...
                {onClose && (
                  <button
                    type="button"
                    onClick={onClose}
                    className="p-1 border-2 border-border rounded text-text-disabled hover:border-black hover:text-black transition-all duration-100 hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[2px_2px_0_rgba(0,0,0,0.15)]"
              ...
              {/* Description */}
              <p id="cookie-consent-description" className="text-text-disabled text-sm leading-relaxed">
              ...
              {showPreferences && (
                <div className="border-2 border-border rounded-[var(--radius-card)] p-4 mt-2 bg-muted">
                  <Label size="sm" className="text-text-disabled mb-3 block">COOKIE PREFERENCES</Label>
                  <Stack gap={3}>
                      ...
                      >
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            <Body size="sm" className="font-semibold text-text-primary">
                              {category.label}
                            </Body>
                            {category.required && (
                              <span className="text-xs px-1.5 py-0.5 bg-muted text-text-disabled rounded font-medium">
                                Required
                              </span>
                            )}
                          </div>
                          <Body size="xs" className="text-text-disabled mt-0.5">
