        ...
        <div ref={ref} className={clsx("grid gap-gap-md", gridClasses[columns], className)} {...props}>
          {images.map((image, index) => (
            <button
              ...
              className="relative overflow-hidden bg-surface-elevated aspect-square border-2 border-black rounded-[var(--radius-card)] shadow-[4px_4px_0_rgba(0,0,0,0.1)] group cursor-pointer hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0_rgba(0,0,0,0.15)] transition-all duration-100 ease-[var(--ease-bounce)]"
            >
              <img
                src={image.src}
                alt={image.alt}
