...
import { appNavigationVariants } from "./AppNavigation.variants.js";
import type { AppNavigationProps } from "./AppNavigation.types.js";
    ...
    return (
      <>
        <header
          ref={ref}
          className={clsx(
            appNavigationVariants({ colorScheme }),
            className
          )}
          {...props}
        >
