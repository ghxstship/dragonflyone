...
import { seatingChartVariants } from "./SeatingChart.variants.js";
import type { SeatingChartProps, Seat } from "./SeatingChart.types.js";
...
export function SeatingChart({
  ...
  return (
    <div className={clsx(seatingChartVariants({ showStage, showLegend }), className)}>
      {/* Stage */}
      {showStage && (
        <div
