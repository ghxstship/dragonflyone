...
import { customFieldRendererVariants, customFieldGroupVariants } from "./CustomFieldRenderer.variants.js";
import type { 
  CustomFieldRendererProps, 
  CustomFieldGroupProps, 
  CustomFieldType, 
  CustomFieldOption 
} from "./CustomFieldRenderer.types.js";
...
export function CustomFieldRenderer({
  ...
  return (
    <div className={clsx(customFieldRendererVariants({ compact }), className)}>
...
export function CustomFieldGroup({
  ...
  const gridClass = customFieldGroupVariants({ columns });
