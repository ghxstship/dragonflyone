              ...
              <div className="col-span-5">
                {readonly ? (
                  ...
                  <input
                    ...
                    className="w-full px-2 py-1 border-2 border-border rounded-button text-body-sm focus:outline-none focus:border-primary"
                  />
                )}
              </div>
              <div className="col-span-2">
                {readonly ? (
                  ...
                  <input
                    ...
                    className="w-full px-2 py-1 border-2 border-border rounded-button text-body-sm text-right focus:outline-none focus:border-primary"
                  />
                )}
              </div>
              <div className="col-span-2">
