...
const triggerIcons: Record<TriggerType, React.ReactNode> = {
  status_change: <FileEdit className="size-4" />,
  date_reached: <Clock className="size-4" />,
  field_update: <FileEdit className="size-4" />,
  threshold_exceeded: <Zap className="size-4" />,
  schedule: <Clock className="size-4" />,
  record_created: <FilePlus className="size-4" />,
  record_deleted: <Trash2 className="size-4" />,
};
