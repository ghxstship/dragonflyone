  ...
  function StatusBadge({ status, size = "md", filled = false, inverted = false, className, children, ...props }, ref) {
    ...
    const lightStatusClasses = {
      ...
      neutral: filled 
        ...
        : "bg-muted border-2 border-border text-on-light-disabled",
      active: filled 
        ? "bg-success-500 text-white" 
        : "bg-success-50 border-2 border-success-500 text-success-700",
      inactive: filled 
    ...
    const darkStatusClasses = {
      ...
      neutral: filled 
        ? "bg-muted text-on-light-primary" 
        : "bg-surface-elevated border-2 border-border text-on-dark-secondary",
      active: filled 
        ? "bg-success-500 text-white" 
        : "bg-success-900 border-2 border-success-400 text-success-300",
      inactive: filled 
        ? "bg-surface-elevated text-on-dark-primary" 
        : "bg-surface-elevated border-2 border-border text-on-dark-muted",
      pending: filled 
        ? "bg-warning-500 text-black" 
        : "bg-warning-900 border-2 border-warning-400 text-warning-300",
    };
