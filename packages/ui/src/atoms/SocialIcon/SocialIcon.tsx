...
import { socialIconVariants } from "./SocialIcon.variants.js";
import type { SocialIconProps } from "./SocialIcon.types.js";

/**
 * SocialIcon component - Social media platform icons with hover effects
 * 
 * @example
 * ```tsx
 * <SocialIcon
