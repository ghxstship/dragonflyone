...
import { authSplitLayoutVariants } from "./AuthSplitLayout.variants.js";
import type { AuthSplitLayoutProps } from "./AuthSplitLayout.types.js";
import { Container, Stack } from "../../foundations/layout.js";
import { Label, Body, H1, H2 } from "../../atoms/Typography/index.js";
...
export const AuthSplitLayout = forwardRef<HTMLDivElement, AuthSplitLayoutProps>(
  function AuthSplitLayout(
    ...
    return (
      <div
        ref={ref}
        className={clsx(authSplitLayoutVariants({ singleColumn, brandBackground }), className)}
        {...props}
      >
