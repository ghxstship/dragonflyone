...
import { clientPortalShellVariants } from "./ClientPortalShell.variants.js";
import type { ClientPortalShellProps, ClientPortalNavItem } from "./ClientPortalShell.types.js";
...
export const ClientPortalShell = forwardRef<HTMLDivElement, ClientPortalShellProps>(
  function ClientPortalShell(
    ...
    const _bgClass = inverted ? "bg-surface-inverse text-text-primary" : "bg-muted text-text-primary";
...
ClientPortalShell.displayName = "ClientPortalShell";
