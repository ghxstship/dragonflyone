        ...
        {controls && (
          ...
          >
            ...
            <div className="relative z-10 p-4 flex flex-col gap-2">
              {/* Progress bar */}
              <div
                className="h-1 bg-grey-700 cursor-pointer group/progress"
                onClick={handleSeek}
              >
                <div
                ...
                />
                <div
                  className="absolute w-3 h-3 bg-white -mt-1 -ml-1.5 opacity-0 group-hover/progress:opacity-100 transition-opacity"
