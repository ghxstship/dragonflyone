...
BEGIN
  ...
  IF v_org_id IS NULL THEN
    ...
    VALUES ('Sample Organization', 'sample-org', '{"industry": "live_entertainment"}'::jsonb)
  ...
  IF v_project_id IS NULL THEN
    INSERT INTO projects (organization_id, name, code, status, budget, start_date, end_date)
    VALUES (
      v_org_id,
