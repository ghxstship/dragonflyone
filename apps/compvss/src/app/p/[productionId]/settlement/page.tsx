                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <Body size="sm" className="text-grey-400">{item.category}</Body>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
        ...
        <Section>
          ...
          <Grid cols={2} gap={4} className="grid-cols-1 md:grid-cols-2 mt-4">
            <Card className="p-6">
              ...
              <Body size="sm" className="text-grey-400 mb-4">Complete settlement breakdown</Body>
            ...
            <Card className="p-6">
              ...
              <Body size="sm" className="text-grey-400 mb-4">Line-by-line expense report</Body>
