        ...
        <Section>
          ...
          {filteredNotifications.length === 0 ? (
            <Card className="p-8 text-center">
              ...
              <Body className="text-text-muted">You are all caught up!</Body>
            </Card>
          ) : (
            <Stack gap={2}>
                    ...
                    <Box className="flex items-start gap-4">
                      ...
                      <Box className="flex-1">
                        <Box className="flex items-start justify-between">
                          <Box>
                            <Body className={`font-weight-medium ${!notification.read ? "" : "text-text-muted"}`}>{notification.title}</Body>
                            <Body size="sm" className="text-text-muted">{notification.message}</Body>
                          </Box>
                          <Body size="sm" className="text-text-disabled">{formatDate(notification.created_at)}</Body>
                        </Box>
                      </Box>
                      {!notification.read && (
