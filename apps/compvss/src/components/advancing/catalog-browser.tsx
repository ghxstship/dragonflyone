...
export function CatalogBrowser({ onSelectItem, selectedItems = [] }: CatalogBrowserProps) {
  ...
  const selectedCategoryData = categories.find(
    (c: CatalogCategory) => c.category === selectedCategory
  );
  ...
  return (
    <Card>
      <CardHeader>
        <H3>Production Catalog</H3>
        <Body>500+ universal production items across 36 categories</Body>
      </CardHeader>
