        ...
        <Section border>
          ...
          {events.length > 0 ? (
            ...
            <Card inverted className="p-6">
              <Body className="text-text-muted">No upcoming events at this venue.</Body>
            </Card>
          )}
        </Section>
      ),
    },
    {
      ...
      content: venue?.amenities && venue.amenities.length > 0 ? (
        ...
        <Section border>
          <SectionHeader title="Venue Amenities" />
          <Card inverted className="p-6">
            <Body className="text-text-muted">No amenities information available.</Body>
          </Card>
        </Section>
      ),
    },
      ...
      content: (
        <>
          ...
          <Section border>
            ...
            <Card inverted className="p-4">
              <Body className="text-text-secondary mb-4">
