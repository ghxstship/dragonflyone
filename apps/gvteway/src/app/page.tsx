...
// =============================================================================
// GVTEWAY MEMBERSHIP LANDING PAGE
// Marketing page for GVTEWAY - Experience Membership Platform
...
function CtaSection() {
  return (
    <Stack className="relative overflow-hidden py-32">
      <Box
...
const marketingSections: MarketingSection[] = [
  { id: "hero", background: "black", content: <HeroSection /> },
  { id: "welcome", background: "ink", content: <WelcomeSection /> },
  { id: "experience", background: "ink", content: <ExperienceOverviewSection /> },
  { id: "categories", background: "ink", content: <CategoriesSection /> },
  { id: "benefits", background: "ink", content: <BenefitsSection /> },
  { id: "how-it-works", background: "ink", content: <HowItWorksSection /> },
  { id: "pricing", background: "ink", content: <PricingSection /> },
  { id: "testimonials", background: "ink", content: <TestimonialsSection /> },
  { id: "cta", background: "ink", content: <CtaSection /> },
];
