...
/**
 * Templates Page - GVTEWAY Marketing
...
export default function TemplatesPage() {
  ...
  const platformTemplates = TEMPLATES.filter(t => t.platform === 'gvteway' || t.platform === 'all');
      ...
      sections={[
        {
          ...
          content: (
            <HeroSection
              ...
              description="Ready-to-use templates for marketing, ticketing, and guest management. All templates are dual-purpose: human-readable and import-ready."
              background="gradient"
              pattern="none"
              fullHeight={false}
              align="center"
                  ...
                  <Grid cols={2} gap={4} className="grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    {filteredTemplates.map((template) => {
                      ...
                      return (
                        <Card
                          key={template.id}
                          className="p-5 border-2 border-border rounded-card pop-card-gvteway group"
                        >
                          <Stack gap={4}>
