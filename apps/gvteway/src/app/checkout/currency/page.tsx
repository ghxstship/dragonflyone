                  ...
                  <TableBody>
                    {mockCurrencies.map((currency) => (
                      <TableRow key={currency.code}>
                        ...
                        <TableCell><Label className={currency.enabled ? "text-green-600" : "text-gray-400"}>{currency.enabled ? "Enabled" : "Disabled"}</Label></TableCell>
                        <TableCell><Label className="text-gray-500">{currency.lastUpdated}</Label></TableCell>
                        <TableCell>
                  ...
                  <Card key={idx} className="border-2 border-black p-6">
                    <Stack gap={4}>
                      <Stack direction="horizontal" className="justify-between">
                        ...
                        <Stack direction="horizontal" gap={2}>
                          <Label className="text-gray-500">Base:</Label>
                      ...
                      <Grid cols={4} gap={4}>
                        {price.localizedPrices.map((lp, lpIdx) => {
                          ...
                          return (
                            <Card key={lpIdx} className="p-3 border border-gray-200 text-center">
                              <Stack gap={1}>
                        ...
                        <Card className="p-3 border border-dashed border-gray-300 text-center cursor-pointer">
                          <Stack gap={1}>
                            <Label className="text-2xl">+</Label>
                            <Label className="text-gray-500">Add Price</Label>
                          </Stack>
                        </Card>
                      </Grid>
                    </Stack>
          ...
          {selectedCurrency && (
            <Stack gap={4}>
              ...
              <Grid cols={2} gap={4}>
                ...
                <Stack gap={1}>
                  <Label className="text-gray-500">Exchange Rate (to USD)</Label>
