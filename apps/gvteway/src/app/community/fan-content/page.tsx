            ...
            {filteredContent.map((content) => (
              <Card key={content.id} className="border-2 border-black overflow-hidden cursor-pointer" onClick={() => setSelectedContent(content)}>
                ...
                <Stack className="p-4" gap={3}>
                  ...
                  <Label className="text-gray-500">by {content.creator}</Label>
                  <Label size="xs" className="text-gray-400">{content.eventName}</Label>
            ...
            <Stack gap={4}>
              ...
              <Stack direction="horizontal" className="justify-between">
                <Stack gap={1}>
                  ...
                  <Label className="text-gray-500">{selectedContent.eventName}</Label>
                </Stack>
                <Label className="text-gray-400">{selectedContent.createdAt}</Label>
              </Stack>
      ...
      <Modal open={showSubmitModal} onClose={() => setShowSubmitModal(false)}>
        ...
        <ModalBody>
          <Stack gap={4}>
            ...
            <Card className="p-8 border-2 border-dashed border-gray-400 text-center cursor-pointer">
              <Label className="text-gray-500">Drop file or click to upload</Label>
            </Card>
          </Stack>
        </ModalBody>
        <ModalFooter>
