      ...
      <Container>
        {venue.image && (
          <Section className="mb-8 -mx-4 md:-mx-8">
            <Figure className="relative h-64 md:h-96 bg-gray-100 overflow-hidden">
              <Image
                src={venue.image}
                alt={venue.name}
                fill
          ...
          <Stack className="col-span-2" gap={8}>
            {venue.description && (
              <Card className="p-6">
                ...
                <Body className="text-gray-600">{venue.description}</Body>
              </Card>
            )}
            ...
            <Section>
              ...
              {events.length > 0 ? (
                ...
                <Card className="p-8 text-center">
                  <Body className="text-gray-500">No upcoming events at this venue.</Body>
                </Card>
              )}
            </Section>
          </Stack>
          ...
          <Stack gap={6}>
              ...
              <Card className="p-6">
                ...
                <Stack gap={2}>
                  {venue.amenities.map((amenity, index) => (
                    <Body key={index} className="text-gray-600">• {amenity}</Body>
                  ))}
                </Stack>
              </Card>
            )}
            ...
            {venue.accessibility_info && (
              <Card className="p-6">
                ...
                <Body className="text-gray-600">{venue.accessibility_info}</Body>
              </Card>
            )}
            ...
            {venue.parking_info && (
              <Card className="p-6">
                ...
                <Body className="text-gray-600">{venue.parking_info}</Body>
              </Card>
            )}
            ...
            {venue.public_transit && (
              <Card className="p-6">
                ...
                <Body className="text-gray-600">{venue.public_transit}</Body>
              </Card>
            )}
