...
export default function SeatingPage() {
  ...
  const getSeatColor = (status: string, isSelected: boolean) => {
    ...
    switch (status) {
      case 'available': return 'bg-white border-2 border-black hover:bg-ink-100 cursor-pointer';
      case 'reserved': return 'bg-ink-300 cursor-not-allowed';
      case 'sold': return 'bg-ink-600 text-white cursor-not-allowed';
          ...
          <Stack className="col-span-2" gap={6}>
            <Card className="p-6">
              ...
              <Stack direction="horizontal" gap={6} className="mt-8 justify-center">
                ...
                <Stack direction="horizontal" gap={2} className="items-center">
                  <Stack className="w-6 h-6 bg-ink-300" />
                  <Label>Reserved</Label>
                </Stack>
                <Stack direction="horizontal" gap={2} className="items-center">
                  <Stack className="w-6 h-6 bg-ink-600" />
                  <Label>Sold</Label>
                </Stack>
              </Stack>
            </Card>
                ...
                <Stack gap={4}>
                  <Stack gap={2}>
                    {selectedSeats.map(seatId => {
                      ...
                      return seat ? (
                        <Stack key={seatId} direction="horizontal" className="justify-between items-center py-2 border-b border-ink-200">
