                ...
                {recentActivity.slice(0, 5).map((item: RecentActivity) => (
                  <Box key={item.id} className="flex items-center gap-3 py-2 border-b border-border last:border-0">
                    ...
                    <Box className="flex-1">
                      ...
                      <Body size="sm" className="text-text-muted">{formatTime(item.timestamp)}</Body>
                    </Box>
                    {item.amount && (
      ...
      content: (
        <Section>
          ...
          <Grid cols={3} gap={6} className="grid-cols-1 lg:grid-cols-3">
            <Card className="p-6">
              <Body size="sm" className="text-text-muted">Active Events</Body>
            ...
            <Card className="p-6">
              <Body size="sm" className="text-text-muted">Today&apos;s Sales</Body>
            ...
            <Card className="p-6">
              <Body size="sm" className="text-text-muted">Conversion Rate</Body>
              <Body className="text-display-md font-weight-bold mt-2">4.2%</Body>
              <Body size="sm" className="text-text-muted mt-1">Industry avg: 3.1%</Body>
            </Card>
          </Grid>
        </Section>
      ),
