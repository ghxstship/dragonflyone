    ...
    content: (
      <Section>
        <Card className="p-8 text-center mb-6">
          ...
          <Body className="text-text-muted">Your tickets have been sent to your email</Body>
        ...
        <Grid cols={2} gap={4} className="grid-cols-1 md:grid-cols-2 mb-6">
          <Card className="p-6 text-center cursor-pointer hover:border-primary transition-colors">
            ...
            <Body size="sm" className="text-text-muted">Access your digital tickets</Body>
          </Card>
          <Card className="p-6 text-center cursor-pointer hover:border-primary transition-colors">
            <Download className="size-8 text-primary mx-auto mb-3" />
            <Body className="font-weight-bold">Download PDF</Body>
            <Body size="sm" className="text-text-muted">Save tickets to your device</Body>
          </Card>
        </Grid>
