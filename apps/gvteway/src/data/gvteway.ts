...
export const gvtewaySidebarNavigation = [
  {
    ...
    items: [
      { id: "dashboard", label: "Dashboard", href: "/dashboard", icon: "LayoutDashboard", primary: true },
  ...
  },
  {
    ...
    icon: "Compass",
    items: [
      { id: "browse-events", label: "Browse Events", href: "/events", icon: "Calendar", primary: true },
      { id: "search", label: "Search", href: "/search", icon: "Search" },
      { id: "discover", label: "Discover", href: "/discover", icon: "Sparkles" },
      { id: "artists", label: "Artists", href: "/artists", icon: "Music" },
      { id: "venues", label: "Venues", href: "/venues", icon: "MapPin" },
    ...
    subsections: [
      {
        label: "Explore",
        items: [
          { id: "browse-all", label: "Browse All", href: "/browse", icon: "Compass" },
          { id: "watch-parties", label: "Watch Parties", href: "/watch-parties", icon: "Video" },
        ],
      },
    ],
  },
  {
    ...
    icon: "Ticket",
    items: [
      { id: "all-tickets", label: "All Tickets", href: "/tickets", icon: "Ticket", primary: true },
  ...
  },
  {
    ...
    icon: "Users",
    items: [
      { id: "community", label: "Community", href: "/community", icon: "Users", primary: true },
  ...
  },
  {
    ...
    icon: "ShoppingBag",
    items: [
      { id: "merch-store", label: "Merch Store", href: "/merch", icon: "ShoppingCart", primary: true },
      { id: "cart", label: "Cart", href: "/cart", icon: "ShoppingCart" },
      { id: "bundles", label: "Bundles", href: "/merch/bundles", icon: "Package" },
      { id: "gift-cards", label: "Gift Cards", href: "/gift-cards", icon: "CreditCard" },
  ...
  },
  {
    ...
    icon: "User",
    items: [
      { id: "profile", label: "Profile", href: "/profile", icon: "User", primary: true },
      { id: "my-account", label: "My Account", href: "/account", icon: "UserCircle" },
      { id: "wallet", label: "Wallet", href: "/wallet", icon: "Wallet" },
      { id: "rewards", label: "Rewards", href: "/rewards", icon: "Gift" },
      { id: "apply", label: "Apply", href: "/apply", icon: "FileText" },
    ],
    subsections: [
      {
        label: "Account Details",
        items: [
          { id: "my-tickets", label: "My Tickets", href: "/account/tickets", icon: "Ticket" },
          { id: "my-orders", label: "My Orders", href: "/account/orders", icon: "ShoppingBag" },
          { id: "my-profile", label: "My Profile", href: "/account/profile", icon: "UserCircle" },
        ],
      },
      {
        label: "Settings",
        items: [
          ...
          { id: "privacy", label: "Privacy", href: "/settings/privacy", icon: "Lock" },
          ...
          { id: "sessions", label: "Sessions", href: "/settings/sessions", icon: "Monitor" },
          { id: "connected-apps", label: "Connected Apps", href: "/settings/connected-apps", icon: "Plug" },
        ],
      },
      {
        label: "Developer",
        ...
        items: [
          ...
          { id: "api-access", label: "API Access", href: "/settings/api-access", icon: "Code" },
  ...
  },
  {
    ...
    icon: "HelpCircle",
    items: [
      { id: "help-center", label: "Help Center", href: "/help", icon: "HelpCircle", primary: true },
      { id: "support-chat", label: "Support Chat", href: "/support/chat", icon: "MessageCircle" },
    ],
  },
];
...
// Membership tiers
export const gvtewayMembershipTiers = [
  {
    name: "MEMBER",
    price: "$49",
    period: "/mo",
...
// Membership benefits - icons are string references to be mapped in component
export const gvtewayMembershipBenefits = [
  {
    icon: "Lock",
...
// Get Started steps - icons are string references to be mapped in component
export const gvtewayGetStartedSteps = [
  {
    step: 1,
    icon: "FileText",
...
// Testimonials
export const gvtewayTestimonials = [
  {
