            ...
            <Container size="xl" className="py-20">
              <Stack gap={8}>
                <Stack gap={4} className="text-center items-center">
                  ...
                  <Body className="text-grey-400 max-w-2xl">We maintain rigorous compliance with industry standards and undergo regular third-party audits.</Body>
                </Stack>
                    ...
                    <Card key={cert.id} className="p-6 border-2 border-grey-800 rounded-card hover:border-success/30 transition-all">
                      <Stack direction="horizontal" gap={4} className="items-start">
                        ...
                        <Stack gap={2} className="flex-1">
                          ...
                          <Body className="text-grey-400">{cert.description}</Body>
                        </Stack>
                      </Stack>
                    </Card>
                  ))}
                ...
                <Stack direction="horizontal" className="justify-between items-center flex-wrap gap-8">
                  <Stack direction="horizontal" gap={6} className="items-center">
                    ...
                    <Stack gap={2}>
                      ...
                      <Body className="text-grey-400">Download our comprehensive security documentation detailing our practices, architecture, and compliance measures.</Body>
                    </Stack>
                  </Stack>
