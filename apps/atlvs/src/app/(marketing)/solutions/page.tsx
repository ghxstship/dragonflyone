            ...
            <Container size="xl" className="py-20">
              <Stack gap={8}>
                <Stack gap={4} className="text-center items-center">
                  ...
                  <Body className="text-grey-400 max-w-2xl">Tools designed for your specific role in the production ecosystem.</Body>
                </Stack>
                      ...
                      <Stack direction="horizontal" className="justify-between items-start gap-4">
                        <Stack direction="horizontal" gap={4} className="items-start">
                          ...
                          <Stack gap={1}>
                            ...
                            <Body size="sm" className="text-grey-400">{role.description}</Body>
                          </Stack>
                        </Stack>
                        <ArrowRight className="size-5 text-grey-600 group-hover:text-primary transition-colors flex-shrink-0" />
                      </Stack>
                    </Card>
                  ))}
                </Grid>
