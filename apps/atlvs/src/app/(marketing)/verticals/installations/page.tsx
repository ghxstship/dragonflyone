...
import { Wrench, Check, ArrowRight, List } from "lucide-react";
...
export default function InstallationsVerticalPage() {
  ...
  const tabs = [{
    ...
    content: (
      <Section>
        <Card className="p-8 mb-8"><Body className="font-weight-bold text-grey-300">Complete platform for event installations and technical production.</Body></Card>
