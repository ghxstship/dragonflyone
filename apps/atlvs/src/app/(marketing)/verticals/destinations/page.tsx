...
const BENEFITS = ["Maximize utilization", "Streamlined bookings", "Better coordination", "Revenue optimization"];
...
export default function DestinationsVerticalPage() {
  ...
  const tabs = [{
    ...
    content: (
      <Section>
        <Card className="p-8 mb-8"><Body className="font-weight-bold text-on-dark-secondary">Complete platform for venues and destinations hosting live events.</Body></Card>
  ...
  return <DetailPage header={{ kicker: "Verticals", title: "Destinations", description: "Venue and destination management" }} backButton={{ label: "Home", href: "/" }} tabs={tabs} actions={<Button variant="solid" onClick={() => router.push("/demo")}>Get Started</Button>} />;
}
