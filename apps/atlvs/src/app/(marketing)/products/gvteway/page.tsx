    ...
    <>
      ...
      <Container className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
        <Stack gap={6} className="items-center text-text-primary sm:gap-8">
          ...
          <Display className="text-text-primary text-display-sm sm:text-display-md lg:text-display-lg">GVTEWAY</Display>
      ...
      {/* Overview Section */}
      <Box className="bg-surface-inverse">
        <Container className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
          <Article className="border-2 border-border bg-muted p-6 sm:p-8 lg:p-12 pop-card-gvteway">
      ...
      <Box className="bg-text-text-primary">
        <Container className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
          <Stack gap={4} className="text-text-primary mb-12">
            ...
            <Body size="lg" className="text-text-muted max-w-2xl mx-auto">Everything you need to sell tickets and manage access</Body>
          </Stack>
          <Grid cols={3} gap={6} className="grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map((feature, idx) => (
              <Article key={idx} className="border-2 border-border bg-surface-inverse p-6 pop-card-gvteway">
      ...
      <Container className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
        <Grid cols={2} gap={8} className="grid-cols-1 lg:grid-cols-2 items-center">
          <Stack gap={6}>
            <Stack gap={2}>
              <Label size="xs" className="text-brand-cyan">WHY GVTEWAY</Label>
              <H1 className="text-text-primary">THE TICKETING ADVANTAGE</H1>
            </Stack>
            <Stack gap={3}>
          ...
          <Card className="border-2 border-border bg-surface-inverse p-8 text-text-primary">
            <Stack gap={4} className="items-center">
              ...
              <Body className="text-text-muted">See GVTEWAY in action with a personalized demo</Body>
              <Stack direction="horizontal" gap={4} className="flex-wrap justify-center">
      ...
      <Box className="bg-text-text-primary">
        <Container className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
          <Stack gap={4} className="text-text-primary mb-12">
            ...
            <Body size="lg" className="text-text-muted max-w-2xl mx-auto">Hear from event organizers using GVTEWAY</Body>
          </Stack>
          <Grid cols={2} gap={6} className="grid-cols-1 md:grid-cols-2">
            {TESTIMONIALS.map((testimonial, idx) => (
              <Article key={idx} className="border-2 border-border bg-surface-inverse p-6 pop-card">
      ...
      <Container className="mx-auto max-w-container-4xl px-4 text-text-primary sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
        <Display size="md" className="text-text-primary">SELL MORE TICKETS</Display>
