      ...
      <SectionLayout background="grey">
        <Stack gap={8} className="mx-auto max-w-2xl">
          ...
          <Card variant="elevated" className="p-8">
            ...
            {currentStep === "role" && (
              <Stack gap={4}>
                <Body className="text-center text-muted">Select your primary role in ATLVS:</Body>
                <Stack gap={3}>
                ...
                <Stack gap={4}>
                  <Stack direction="horizontal" gap={3} className="items-center">
                    <Checkbox
                      ...
                      className="border-2"
                    />
                    <Body className="text-muted">Email notifications for project updates</Body>
                  </Stack>
                  <Stack direction="horizontal" gap={3} className="items-center">
                    <Checkbox
                      id="push"
            ...
            {currentStep === "complete" && (
              <Stack gap={6} className="text-center">
                ...
                <H3 className="uppercase tracking-display">Welcome to ATLVS!</H3>
                <Body className="text-muted">Your account is all set up. You&apos;re ready to start managing your projects.</Body>
              </Stack>
            )}
