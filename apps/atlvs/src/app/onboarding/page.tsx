    ...
    >
      <SectionLayout background="grey">
        <Stack gap={8} className="mx-auto max-w-2xl bg-white p-8 border border-ink-200">
          ...
          {currentStep === "role" && (
            <Stack gap={4}>
              <Body className="text-ink-600 text-center">Select your primary role in ATLVS:</Body>
              <Stack gap={3}>
          ...
          {currentStep === "complete" && (
            <Stack gap={6} className="text-center">
              ...
              <Body className="text-ink-600">Your account is all set up. You&apos;re ready to start managing your projects.</Body>
            </Stack>
          )}
