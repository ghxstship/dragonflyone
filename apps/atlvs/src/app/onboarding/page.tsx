    ...
    >
      <SectionLayout background="grey">
        <Stack gap={8} className="mx-auto max-w-2xl bg-white p-8 border border-grey-200">
          ...
          {currentStep === "role" && (
            <Stack gap={4}>
              <Body className="text-grey-600 text-center">Select your primary role in ATLVS:</Body>
              <Stack gap={3}>
            ...
            <Stack gap={6}>
              ...
              <Stack gap={4}>
                <Stack direction="horizontal" gap={3} className="items-center">
                  ...
                  />
                  <Body>Email notifications for project updates</Body>
                </Stack>
                <Stack direction="horizontal" gap={3} className="items-center">
                  <Checkbox
                    id="push"
          ...
          {currentStep === "complete" && (
            <Stack gap={6} className="text-center">
              ...
              <H3>Welcome to ATLVS!</H3>
              <Body className="text-grey-600">Your account is all set up. You&apos;re ready to start managing your projects.</Body>
            </Stack>
          )}
