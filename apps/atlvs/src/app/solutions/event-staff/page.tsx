...
const FEATURES = ["Shift scheduling", "Time tracking", "Team communication", "Performance metrics"];
const BENEFITS = ["Streamlined scheduling", "Accurate timekeeping", "Better coordination", "Professional management"];
...
export default function EventStaffSolutionPage() {
  ...
  const tabs = [{
    ...
    content: (
      <Section>
        <Card className="p-8 mb-8"><Body className="text-h5-md text-grey-300">Specialized tools for event staff in the live events industry.</Body></Card>
  ...
  return <DetailPage header={{ kicker: "Solutions", title: "For Event Staff", description: "Professional tools for event staff" }} backButton={{ label: "Solutions", href: "/solutions" }} tabs={tabs} actions={<Button variant="solid" onClick={() => router.push("/demo")}>Get Started</Button>} />;
}
