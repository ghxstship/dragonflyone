...
const FEATURES = ["Contract management", "Invoice tracking", "Project coordination", "Document storage"];
const BENEFITS = ["Streamlined contracts", "Faster payments", "Better coordination", "Professional management"];
...
export default function SubcontractorsSolutionPage() {
  ...
  const tabs = [{
    ...
    content: (
      <Section>
        <Card className="p-8 mb-8"><Body className="text-h5-md text-grey-300">Specialized tools for subcontractors in the live events industry.</Body></Card>
  ...
  return <DetailPage header={{ kicker: "Solutions", title: "For Subcontractors", description: "Professional tools for subcontractors" }} backButton={{ label: "Solutions", href: "/solutions" }} tabs={tabs} actions={<Button variant="solid" onClick={() => router.push("/demo")}>Get Started</Button>} />;
}
