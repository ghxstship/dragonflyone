...
import { Briefcase, Check, ArrowRight, List } from "lucide-react";
import { Body, Button, Card, Grid, Stack, DetailPage, Section, SectionHeader } from "@ghxstship/ui";

const FEATURES = ["Job tracking", "Invoice management", "Contract storage", "Availability calendar"];
const BENEFITS = ["Organized workflow", "Faster payments", "Professional presence", "Better client relations"];
...
export default function IndependentContractorsSolutionPage() {
  ...
  const tabs = [{
    ...
    content: (
      <Section>
        <Card className="p-8 mb-8"><Body className="text-h5-md text-grey-300">Specialized tools for independent contractors in the live events industry.</Body></Card>
  ...
  return <DetailPage header={{ kicker: "Solutions", title: "For Independent Contractors", description: "Professional tools for independent contractors" }} backButton={{ label: "Solutions", href: "/solutions" }} tabs={tabs} actions={<Button variant="solid" onClick={() => router.push("/demo")}>Get Started</Button>} />;
}
