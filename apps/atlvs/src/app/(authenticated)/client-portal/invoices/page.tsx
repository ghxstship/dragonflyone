    ...
    return (
      <div className="p-6">
        <div className="text-center py-12 bg-destructive/10 border-2 border-destructive rounded-card">
          <Body className="text-destructive">Failed to load invoices</Body>
        </div>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-background border-2 border-border rounded-card p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <Text className="text-body-sm text-muted-foreground">Total Invoices</Text>
          </div>
          <Body className="text-h3-md font-weight-bold text-foreground">{summary.total_invoices}</Body>
        </div>
        <div className="bg-background border-2 border-warning/50 rounded-card p-4">
          ...
          <Body className="text-h3-md font-weight-bold text-warning">{formatCurrency(summary.total_due)}</Body>
        </div>
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-right">
                      ...
                      {invoice.balance_due > 0 && (
                        <Body className="text-body-xs text-warning">
