      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-avatar bg-primary/10 flex items-center justify-center">
              <span className="text-primary text-h3-md font-weight-bold">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <span className="text-body-sm">Timeline</span>
          </Link>
          <Link
            ...
            <div className="grid grid-cols-2 gap-6">
              {contact.email && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${contact.email}`} className="text-body-md text-primary hover:underline">
                      {contact.email}
                    </a>
                  </div>
                </div>
              ...
              {contact.phone && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={`tel:${contact.phone}`} className="text-body-md text-primary hover:underline">
                      {contact.phone}
                    </a>
                  </div>
                </div>
              ...
              {contact.company && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-body-xs text-muted-foreground">Company</p>
                    <p className="text-body-md text-foreground">{contact.company}</p>
                  </div>
                </div>
              )}
              {contact.title && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-body-xs text-muted-foreground">Title</p>
                    <p className="text-body-md text-foreground">{contact.title}</p>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="space-y-2">
              {contact.email && (
                ...
                >
                  ...
                  <span className="text-body-sm">Send Email</span>
                </a>
              )}
              {contact.phone && (
                <a
                ...
                >
                  ...
                  <span className="text-body-sm">Call</span>
                </a>
              )}
              <Link
              ...
              >
                ...
                <span className="text-body-sm">Create Deal</span>
              </Link>
            </div>
          </div>
          ...
          <div className="bg-background border-2 border-border rounded-card p-6">
            ...
            <div className="space-y-3 text-body-sm">
              <div className="flex items-center justify-between">
                ...
                <span className="text-foreground capitalize">{contact.type || 'Contact'}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-muted-foreground">Status</span>
                <span className="text-foreground capitalize">{contact.status || 'Active'}</span>
              </div>
              <div className="flex items-center justify-between">
