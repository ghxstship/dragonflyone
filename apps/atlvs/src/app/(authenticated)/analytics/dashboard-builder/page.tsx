  ...
  return (
    <Stack gap={8}>
      <EnterprisePageHeader
        ...
        subtitle="Build custom analytics dashboards"
        showFavorite
        showSettings
      />
      ...
      <Card inverted className="border-2 border-ink-800 p-8">
        <Stack gap={4} className="items-center justify-center py-12">
          <H2 className="text-white">Dashboard Builder</H2>
          <Body className="text-grey-300 text-center max-w-md">
            Build custom analytics dashboards. This page is under development.
          </Body>
        </Stack>
      </Card>
    </Stack>
