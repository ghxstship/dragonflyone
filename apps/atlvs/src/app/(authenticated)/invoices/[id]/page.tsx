      ...
      <Stack gap={6}>
        ...
        {invoice.notes && (
          <Section border>
            ...
            <Body size="sm" className="whitespace-pre-wrap text-text-secondary">{invoice.notes}</Body>
          </Section>
        )}
      </Stack>
    );
              ...
              <Stack gap={4}>
                <Stack gap={2}>
                  ...
                  <Box className="relative">
                    <DollarSign className="absolute left-3 top-1/2 size-4 -translate-y-1/2 text-text-disabled" />
                    <Input
                      type="number"
                      value={paymentAmount}
