        ...
        <>
          ...
          <Section border className="mb-6">
            ...
            <Grid cols={2} gap={4} className="grid-cols-1 md:grid-cols-2">
              <Card inverted className="p-4">
                <Body size="xs" className="text-grey-400 mb-1">Code</Body>
                <Body className="text-white">{place.code || "Not assigned"}</Body>
              </Card>
              <Card inverted className="p-4">
                <Body size="xs" className="text-grey-400 mb-1">Status</Body>
                <Body className="text-white">{place.status}</Body>
              </Card>
              <Card inverted className="p-4">
                <Body size="xs" className="text-grey-400 mb-1">Capacity</Body>
                <Body className="text-white">{place.capacity?.toString() || "Not specified"}</Body>
              </Card>
              <Card inverted className="p-4">
                <Body size="xs" className="text-grey-400 mb-1">Square Footage</Body>
          ...
          {(place.latitude || place.longitude) && (
            <Section border className="mb-6">
              ...
              <Grid cols={2} gap={4} className="grid-cols-1 md:grid-cols-2">
                <Card inverted className="p-4">
                  <Body size="xs" className="text-grey-400 mb-1">Latitude</Body>
                  <Body className="text-white">{place.latitude?.toString() || "Not set"}</Body>
                </Card>
                <Card inverted className="p-4">
                  <Body size="xs" className="text-grey-400 mb-1">Longitude</Body>
          ...
          {place.parent_place && (
            <Section border className="mb-6">
              ...
              <Card inverted className="p-4">
                <Body size="xs" className="text-grey-400 mb-1">Parent Place</Body>
      ...
      content: (
        <Section border>
          ...
          <Card inverted className="p-6">
            <Body className="text-grey-400">Events hosted at this location will be displayed here.</Body>
          </Card>
        </Section>
      ),
    },
    {
      ...
      content: (
        <Section border>
          ...
          <Card inverted className="p-6">
            <Body className="text-grey-400">Interactive map will be displayed here.</Body>
          </Card>
        </Section>
      ),
    },
