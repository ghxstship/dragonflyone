      ...
      content: (
        <Section border>
          ...
          <Card inverted className="p-6">
            <Body className="text-text-muted">Assignment history will be displayed here.</Body>
          </Card>
        </Section>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <Section border>
          ...
          <Card inverted className="p-6">
            <Body className="text-text-muted">Activity timeline will be displayed here.</Body>
          </Card>
        </Section>
      ),
    },
