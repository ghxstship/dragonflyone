        ...
        <Section>
          ...
          {consents.length === 0 ? (
            <Card className="p-8 text-center">
              ...
              <Body className="text-grey-400">Your consent history will appear here</Body>
            </Card>
          ) : (
                ...
                <TableBody>
                  {consents.map((consent: ConsentRecord) => (
                    <TableRow key={consent.id}>
                      ...
                      <TableCell>
                        <Body size="sm" className="text-grey-400">{consent.ip_address} • {consent.user_agent}</Body>
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        {consent && <Body size="sm" className="text-grey-400">Accepted v{consent.version} on {formatDate(consent.accepted_at)}</Body>}
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
