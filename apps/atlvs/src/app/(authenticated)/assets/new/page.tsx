 ...
 * Form for adding new assets to the asset catalog
 * 
...
export default function NewAssetPage() {
  ...
  // Access denied state handled by CreatePage template
  if (!canManageAssets) {
    return (
      <CreatePage
        title="Add New Asset"
        subtitle="Add a new item to the asset catalog"
        backHref="/assets"
        ...
        accessDenied={{
          ...
          description: 'You do not have permission to add new assets.',
