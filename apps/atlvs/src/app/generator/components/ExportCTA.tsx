      ...
      <Container className="mx-auto max-w-container-4xl px-6 lg:px-8">
        <Grid cols={2} gap={12} className="items-center">
          ...
          <Stack gap={6}>
            ...
            <Body className="text-body-lg text-text-disabled">
          ...
          <Card className="border-2 border-border bg-surface-elevated p-8">
            <Text className="mb-6 font-mono text-mono-sm uppercase tracking-kicker text-text-muted">
              What you will get
            </Text>
            <Stack gap={4}>
              {BENEFITS.map((benefit, index) => (
                <Stack key={index} direction="horizontal" gap={3} className="items-start">
                  ...
                  <Text className="text-body-md text-text-muted">{benefit}</Text>
                </Stack>
              ))}
            </Stack>
