...
export default function ProductionsVerticalPage() {
  ...
  const tabs = [{
    ...
    content: (
      <Section>
        <Card className="p-8 mb-8"><Body className="font-weight-bold text-grey-300">Complete platform for live event productions and shows.</Body></Card>
  ...
  return <DetailPage header={{ kicker: "Verticals", title: "Productions", description: "Live event production management" }} backButton={{ label: "Home", href: "/" }} tabs={tabs} actions={<Button variant="solid" onClick={() => router.push("/demo")}>Get Started</Button>} />;
}
