...
import { Zap, Check, ArrowRight, List } from "lucide-react";
...
export default function ActivationsVerticalPage() {
  ...
  const tabs = [{
    ...
    content: (
      <Section>
        <Card className="p-8 mb-8"><Body className="font-weight-bold text-grey-300">Complete platform for brand activations and experiential marketing campaigns.</Body></Card>
