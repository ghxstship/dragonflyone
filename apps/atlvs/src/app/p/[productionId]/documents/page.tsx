                ...
                <Box className="flex items-center justify-between">
                  <Box className="flex items-center gap-4">
                    ...
                    <Box>
                      ...
                      <Body size="sm" className="text-text-muted">{doc.uploaded_by} • {formatDate(doc.uploaded_at)} • {doc.size}</Body>
                    </Box>
                  </Box>
      ...
      content: (
        <Section id={uploadSectionId}>
          ...
          <Card className="p-8 mt-4 text-center border-2 border-dashed">
            ...
            <Body size="sm" className="text-text-muted mb-4">or click to browse</Body>
