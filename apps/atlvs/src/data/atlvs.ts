...
export const atlvsCompvssSection = {
  ...
  features: [
    ...
    },
    {
      icon: "Users",
      title: "STAFF",
      description: "Task assignments, shift management",
    },
    {
      icon: "Building",
      title: "VENDORS",
    ...
    },
    {
      icon: "Mic2",
      title: "ARTISTS",
      description: "Riders, green rooms, backstage access",
    },
    {
      icon: "Briefcase",
      title: "AGENTS",
      description: "Client schedules, contract visibility",
    },
    {
      icon: "Camera",
      title: "MEDIA",
      description: "Credentials, photo pit access, press kits",
    },
    {
      icon: "BadgeDollarSign",
      title: "SPONSORS",
      description: "Activation tracking, brand deliverables",
    },
    {
      icon: "Handshake",
      title: "PARTNERS",
    ...
    },
    {
      icon: "Building2",
      title: "INDUSTRY",
      description: "Networking access, event visibility",
    },
    {
      icon: "GraduationCap",
      title: "INTERNS",
      description: "Task views, learning assignments",
    },
    {
      icon: "Heart",
      title: "VOLUNTEERS",
      description: "Shift schedules, check-in access",
    },
    {
      icon: "Megaphone",
      title: "BRAND AMBASSADORS",
      description: "Referral tracking, promo materials",
    },
    {
      icon: "Link",
      title: "AFFILIATES",
      description: "Commission tracking, referral links",
    },
  ],
