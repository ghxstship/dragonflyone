    ...
    subsections: [
      {
        ...
        items: [
          ...
          { label: "Consent History", href: "/settings/consent-history", icon: "FileText" },
        ],
      },
      {
        label: "Data",
      ...
      {
        label: "Admin",
        allowedRoles: [ATLVS_ROLES.ADMIN],
        items: [
...
// Four pillars for landing page
export const atlvsPillarsSolution = [
  {
    id: "single-source",
    title: "ONE SOURCE. NO DEBATE.",
    description:
      "Your crew checks one place. Your vendors check one place. Your execs check one place. No more 'which spreadsheet?' No more 'did you see my Slack?' One truth. Every decision faster.",
    features: [
      "Single database for projects, crew, gear, and budgets",
      "Real-time sync — changes propagate instantly",
      "Version history on everything, forever",
      "Search across all data in milliseconds",
      "Works offline, syncs when you're back",
    ],
    replaces: "Airtable, Notion, Google Sheets, Slack, Dropbox — and the 47 browser tabs haunting your dreams",
    screenshot: "/images/atlvs-project-dashboard.png",
  },
  {
    id: "built-for-physical",
    title: "SITE TESTED. BOARDROOM APPROVED.",
    description:
      "Built by people who've called shows, not just managed projects. We know load-in doesn't wait for approvals. We know budgets blow up at 2am. This is software that survives contact with reality.",
    features: [
      "Production workflows, not generic project templates",
      "Advancing, call sheets, and run-of-show built in",
      "Gear tracking from warehouse to site to wrap",
      "Crew scheduling with rates, certs, and availability",
      "Budget tracking that handles change orders gracefully",
    ],
    replaces: "Monday, Asana, Smartsheet, Basecamp, ClickUp — and the PM who's never seen a load-in",
    screenshot: "/images/atlvs-workflow-board.png",
  },
  {
    id: "scales-with-you",
    title: "UNLIMITED SCALE. ZERO CATCH.",
    description:
      "Same system for your first popup and your fiftieth festival. No migration when you grow. No consultant when you expand. No 'enterprise tier' when you succeed. Just more of what already works.",
    features: [
      "Portfolio views across all your productions",
      "Clone and template entire project structures",
      "Roll-up reporting for execs and stakeholders",
      "Multi-entity support for complex organizations",
      "API access for custom integrations at any scale",
    ],
    replaces: "Wrike, Teamwork, Productive, Scoro, Kantata — and the 6-month 'enterprise migration' nobody asked for",
    screenshot: "/images/atlvs-resource-allocation.png",
  },
  {
    id: "no-nickel-diming",
    title: "OPEN GUEST LIST. NO REGRETS.",
    description:
      "Invite your whole crew. Every vendor. All your clients. We don't meter collaboration. We don't charge per head. Your success shouldn't come with a surprise invoice.",
    features: [
      "Unlimited internal team members",
      "Unlimited external guests and vendors",
      "Unlimited projects, records, and storage",
      "Unlimited automations and integrations",
      "24/7/365 support included, not upsold",
    ],
    replaces: "LASSO, Salesforce, HubSpot, Jira, ServiceNow — and the finance call where you explain why you added 12 seats",
  ...
  features: [
    {
      icon: "HardHat",
      title: "CREW",
      description: "Your A-team gets their marching orders. No more 47 texts asking 'what time is call?'",
    },
    {
      icon: "Users",
      title: "STAFF",
      description: "Front-of-house to back-of-house. Everyone knows their lane.",
    },
    {
      icon: "Building",
      title: "VENDORS",
      description: "They deliver. You track. Nobody ghosts on a PO again.",
    },
    {
      icon: "Mic2",
      title: "ARTISTS",
      description: "Riders, hospitality, green room vibes. The talent stays happy.",
    },
    {
      icon: "Briefcase",
      title: "AGENTS",
      description: "Their clients, your show. Visibility without the vulnerability.",
    },
    {
      icon: "Camera",
      title: "MEDIA",
      description: "Credentials that work. Photo pits that don't become mosh pits.",
    },
    {
      icon: "BadgeDollarSign",
      title: "SPONSORS",
      description: "Brand activations tracked. ROI proven. Renewals locked.",
    },
    {
      icon: "Handshake",
      title: "PARTNERS",
      description: "Co-productions without the co-dependency. Shared views, separate lanes.",
    },
    {
      icon: "Building2",
      title: "INDUSTRY",
      description: "The right access for the right people. Networking without the chaos.",
    },
    {
      icon: "GraduationCap",
      title: "INTERNS",
    ...
    },
    {
      icon: "Link",
      title: "AFFILIATES",
      description: "Every referral tracked. Every commission earned. No spreadsheet required.",
    },
  ],
  // Role hierarchy from most to least permissions
  roleHierarchy: [
    { role: "EXECUTIVE", level: 1000, description: "Full platform control across ATLVS, COMPVSS, and GVTEWAY" },
    { role: "CORE_AAA", level: 900, description: "Senior leadership with cross-platform access" },
    { role: "AA", level: 800, description: "Department heads with budget and scheduling authority" },
    { role: "PRODUCTION", level: 700, description: "Production managers with advancing and backstage access" },
    { role: "MANAGEMENT", level: 600, description: "Operations managers with reporting visibility" },
    { role: "CREW", level: 500, description: "Technical crew with backstage and task access" },
    { role: "STAFF", level: 450, description: "Event staff with task and shift access" },
    { role: "VENDOR", level: 400, description: "External vendors with PO and delivery access" },
    { role: "ENTERTAINER", level: 350, description: "Performers with backstage and green room access" },
    { role: "ARTIST", level: 350, description: "Artists with backstage and green room access" },
    { role: "AGENT", level: 300, description: "Talent agents with client schedule visibility" },
    { role: "MEDIA", level: 250, description: "Press and photographers with credential access" },
    { role: "SPONSOR", level: 200, description: "Brand sponsors with activation visibility" },
    { role: "PARTNER", level: 200, description: "Co-production partners with shared views" },
    { role: "INDUSTRY", level: 150, description: "Industry professionals with networking access" },
    { role: "BRAND_AMBASSADOR", level: 120, description: "Brand reps with referral and promo access" },
    { role: "INTERN", level: 100, description: "Interns with task view and learning access" },
    { role: "AFFILIATE", level: 100, description: "Affiliates with commission and referral tracking" },
    { role: "VOLUNTEER", level: 50, description: "Volunteers with shift and check-in access" },
  ],
...
export const atlvsPricing = {
  ...
  subheadline: "Seven tiers. Three products. Use what you need. Keep what you have.",
  // Experience Generator - Free AI tool
  experienceGenerator: {
    id: "experience-generator",
    name: "EXPERIENCE GENERATOR",
    subtitle: "AI-Powered Design",
    price: "FREE",
    description: "Transform any idea into a production blueprint with AI. No signup required.",
    color: "primary",
    features: [
      "AI-powered blueprint generation",
      "Export to PDF",
      "One-click import to ATLVS",
      "Unlimited generations",
      "No credit card required",
    ],
    cta: { label: "TRY IT FREE", href: "/generator" },
  },
  // Single Products - Individual apps
  singleProducts: {
    category: "SINGLE PRODUCTS",
    tagline: "BYO EVERYTHING ELSE",
    startingPrice: "$0",
    description: "Use one product. Keep your existing tools for everything else.",
    products: [
      {
        id: "gvteway-single",
        name: "GVTEWAY",
        ...
        annualPrice: "$0",
        period: "/month",
        description: "Modern ticketing and access control for live events.",
        color: "brand-yellow",
        features: [
        ...
        cta: { label: "START FREE", href: "/auth/signup?product=gvteway" },
      },
      {
        id: "compvss-single",
        name: "COMPVSS",
        ...
        annualPrice: "$490",
        period: "/month",
        description: "Complete crew management for live events.",
        color: "brand-cyan",
        features: [
        ...
        cta: { label: "START TRIAL", href: "/auth/signup?product=compvss" },
      },
      {
        id: "atlvs-single",
        name: "ATLVS",
        ...
        annualPrice: "$990",
        period: "/month",
        description: "Production management platform for live events.",
        color: "brand-pink",
        features: [
          "Unlimited projects",
          "Document management",
        ...
        cta: { label: "START TRIAL", href: "/auth/signup?product=atlvs" },
      },
    ],
  },
  // Bundles - Two-product combinations
  // Pricing logic: OPERATIONS (field ops only) < EXPERIENCE (business + revenue) < PRODUCTION (full management)
  bundles: {
    category: "BUNDLES",
    tagline: "FILL THE GAPS",
    startingPrice: "$249",
    description: "Two products that work together. Keep what you love.",
    popular: true,
    products: [
      {
        id: "operations",
        name: "OPERATIONS",
        subtitle: "Crews + Tickets",
        products: ["COMPVSS", "GVTEWAY"],
        price: "$249",
        annualPrice: "$2,490",
        period: "/month",
        description: "Field operations and guest access. Perfect for venues and festivals.",
        color: "success",
        features: [
        ...
        cta: { label: "START TRIAL", href: "/auth/signup?bundle=operations" },
      },
      {
        id: "experience",
        name: "EXPERIENCE",
        subtitle: "Business + Tickets",
        products: ["ATLVS", "GVTEWAY"],
        price: "$349",
        annualPrice: "$3,490",
        period: "/month",
        description: "Production management meets guest experience. For event producers.",
        color: "warning",
        features: [
          "Everything in ATLVS",
          "Everything in GVTEWAY",
          "Budget-to-revenue tracking",
          "2.5% transaction fees",
          "Priority support",
          "90-day data retention",
        ],
        cta: { label: "START TRIAL", href: "/auth/signup?bundle=experience" },
        popular: true,
      },
      {
        id: "production",
        name: "PRODUCTION",
        subtitle: "Business + Crews",
        products: ["ATLVS", "COMPVSS"],
        price: "$449",
        annualPrice: "$4,490",
        period: "/month",
        description: "Complete production management. For agencies and production companies.",
        color: "secondary",
        features: [
          "Everything in ATLVS",
          "Everything in COMPVSS",
        ...
        cta: { label: "START TRIAL", href: "/auth/signup?bundle=production" },
      },
    ],
  },
  ...
  fullStack: {
    ...
    annualPrice: "$14,990",
    period: "/month",
    description: "All three products. Lowest fees. One platform.",
    products: ["ATLVS", "COMPVSS", "GVTEWAY"],
    features: [
      "Everything in all products",
    ...
    cta: { label: "GO ENTERPRISE", href: "/contact?plan=enterprise" },
  },
  // Legacy tiers format for backwards compatibility with PricingSection component
  tiers: [
    {
      id: "gvteway",
      name: "GVTEWAY",
      ...
      period: "/month",
      annualPeriod: "/year",
      description: "Modern ticketing and access control. Start free, pay as you grow.",
      features: [
        "Unlimited ticket sales",
        "QR-based access control",
        "Real-time analytics",
    ...
    },
    {
      ...
      period: "/month",
      annualPeriod: "/year",
      description: "Complete crew management for productions of any size.",
      features: [
        "Unlimited crew members",
        "Scheduling & availability",
    ...
    },
    {
      ...
      period: "/month",
      annualPeriod: "/year",
      description: "COMPVSS + GVTEWAY. Field operations and guest access.",
      features: [
        "Everything in COMPVSS",
        "Everything in GVTEWAY",
        "Crew-to-ticket sync",
    ...
    },
    {
      ...
      period: "/month",
      annualPeriod: "/year",
      description: "ATLVS + GVTEWAY. Production management meets guest experience.",
      features: [
        "Everything in ATLVS",
        "Everything in GVTEWAY",
        "Budget-to-revenue tracking",
    ...
    },
    {
      ...
      period: "/month",
      annualPeriod: "/year",
      description: "ATLVS + COMPVSS. Complete production management suite.",
      features: [
        "Everything in ATLVS",
        "Everything in COMPVSS",
        "Full workflow automation",
  ...
  footnote: "No per-seat charges. Unlimited users on ATLVS and COMPVSS. All plans include 14-day free trial.",
};
