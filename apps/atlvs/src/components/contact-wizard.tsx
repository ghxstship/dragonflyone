...
export function ContactWizard() {
  ...
  return (
    <Card className="p-8">
      <Stack gap={8}>
        <Stack gap={4}>
          <Label className="font-code text-mono-xs uppercase tracking-display text-text-disabled">Multi-Step Wizard</Label>
        ...
        <Form>
          <Stack gap={6}>
            <Stack>
              ...
              <Body className="mt-2 text-text-secondary">{step.description}</Body>
            </Stack>

            <Stack gap={4}>
              {step.fields.map((field) => (
                <Stack key={field.id} gap={2}>
                  <Label className="text-mono-xs uppercase tracking-kicker text-text-disabled">
                    {field.label}
                  </Label>
                  {field.type === "textarea" ? (
                    <Textarea
                  ...
                  <Body className="text-micro uppercase tracking-kicker text-text-muted">
                    {errors[field.id] ? (
            ...
            <Stack direction="horizontal" gap={4} className="flex-col md:flex-row md:items-center md:justify-between">
              <Body className="text-mono-xs uppercase tracking-kicker text-text-muted">
